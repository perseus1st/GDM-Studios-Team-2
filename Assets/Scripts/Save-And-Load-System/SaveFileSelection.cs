...
public class SaveFileSelection : MonoBehaviour
{
    ...
    private void OnEnable(){
        ...
        {
            file1Text.text = "<size=60%><sprite name=floppy-disk-white></size> File 1";
        } else
        {
        ...
        {
            file2Text.text = "<size=60%><sprite name=floppy-disk-white></size> File 2";
        } else
        {
        ...
        {
            file3Text.text = "<size=60%><sprite name=floppy-disk-white></size> File 3";
        } else
        {
