...
public class Cutscene1AudioManager : MonoBehaviour
{
    public static Cutscene1AudioManager INSTANCE;
    ...
    private void Awake()
    {
        ...
        {
            Debug.LogError("AudioSources are not assigned in Cutscene1AudioManager!");
        }
